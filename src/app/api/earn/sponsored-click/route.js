...
const VERSE_PER_CLICK = 1;      // 1 VERSE per sponsored click
const DAILY_CLICK_LIMIT = 20;   // Max 20 clicks per day = 20 VERSE
const MIN_SECONDS_BETWEEN = 10; // 10 second gap anti-fraud
